...
def mainScreen():    
    ...
    def getLoginPass():
        checkHashPass = userpass.get()
        cur.execute("SELECT * FROM login_password WHERE id = 1 AND password = ?", [(checkHashPass)])
        return cur.fetchall()
